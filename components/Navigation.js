            ...
            <Navbar expand="lg">
                ...
                <Nav className="mr-auto" variant="pills" defaultActiveKey="/home">
                    ...
                    <NavDropdown title="About" id="basic-nav-dropdown">
                        ...
                        <NavDropdown.Item href="/information/accessibility">Accessibility</NavDropdown.Item>
                        ...
                        <NavDropdown.Item href="/information/ticket-information">Ticket Information</NavDropdown.Item>
                    </NavDropdown>
