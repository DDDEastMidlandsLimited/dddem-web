...
function CodeOfConduct() {
  return (
    <section id="code-of-conduct">
      ...
      <p tabIndex="0">
        All involved in the DDD East Midlands Conference are subject to{' '}
        <a href="https://www.dddeastmidlands.com/code-of-conduct/">
          Code Of Conduct Page.
      </a>
      This is not just for the day of the event, but for all presence
      of DDD East Midlands including Social Media.
    </p>
      <p tabIndex="0">
