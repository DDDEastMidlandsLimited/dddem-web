...
const Catering = props => (
  <section id="catering">
    ...
    <p tabIndex="0">
      Lunch and snacks will be provided on the day. This will be a hot
      buffet lunch and the options will be chefs choice on the day.
    </p>
    <p tabIndex="0">
    ...
    <p tabIndex="0">
      We will not be serving alcohol as part of the event and ask that
      you don't bring any with you as we are not licenced.
    </p>
