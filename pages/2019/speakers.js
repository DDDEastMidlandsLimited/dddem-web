  ...
  return (
    <Layout>
      ...
      <section>
        ...
        <p tabIndex="0">
          Software and technology has changed every aspect of the world
          we live in. At one extreme are the ‘mission critical’
          applications - the code that runs our banks, our hospitals,
          our airports and phone networks. Then there’s the code we all
          use every day to browse the web, watch movies, create
        ...
        <p tabIndex="0">
          ...
          laugh, maybe even dance? Maybe even code that does nothing at
          all, created just to see if it was possible?
      </p>
        <p tabIndex="0">
          Join Dylan Beattie - programmer, musician, and creator of the
          Rockstar programming language - for an entertaining look at
          the art of code. We’ll look at the origins of programming as
          an art form, from Conway's Game of Life to the 1970s demoscene
          and the earliest Obfuscated C competitions. We’ll talk about
          esoteric languages and quines - how DO you create a program
          that prints its own source code? We’ll look at quine relays,
          code golf and generative art, and we’ll explore the phenomenon
          of live coding as performance - from the pioneers of
          electronic music to modern algoraves and live coding platforms
          like Sonic Pi.
      </p>
        ...
        <div className="row">
          ...
          <div className="columnright">
            ...
            <p tabIndex="0">
              ...
              He's the CTO at Skills Matter in London, he's a Microsoft
              MVP, and he's a regular speaker at conferences and user
              groups, where he's spoken about topics from continuous
              delivery and Conway's Law to the history of the web,
              federated authentication and hypermedia APIs. When he's
              not wrangling code, Dylan plays guitar and writes songs
            about code. He's online at{' '}
      ...
      <section name="matt-brunt">
        ...
        <p tabIndex="0">
          ...
          us secure them. You have a lot of data in your organisations.
          Whether you think it's sensitive or not, it has value. Whether
          an attacker wants data for profit, a grudge, or just for fun
          we need to ensure that we don't just leave the door open for
        them to take what they want.{' '}
        </p>
        <p tabIndex="0">
          In this session we'll start to think like a hacker. The what,
          why, who, where and how of an attacking mindset will leave you
          with practical steps you can take away and use to start
          protecting your systems a little better.
      </p>
        <h3 tabIndex="0">Bio</h3>
        <div className="row">
          <div className="columnleft">
      ...
      <section name="jessica-salisbury">
        ...
        <Link
          ...
          >
            <a target="_blank" aria-label="Jessica Salisbury: Twitter">
              <FontAwesomeIcon icon={['fab', 'twitter']} />
            </a>
          </Link>
          <Link
          ...
          >
            <a target="_blank" aria-label="Jessica Salisbury: LinkedIn">
        ...
        <p tabIndex="0">
          ...
          secretly underlies every corner of our existence. The concept
          spans schools of thought in psychology, economics, biology and
          neuroscience and is now emerging in the intersection of
          technology and behavioural science.
      </p>
        <p tabIndex="0">
          As technologists we are always looking to build products that
          are engaging and effective, and as people we strive to reach
          our full personal and working potential. Could the feedback
          loop be the piece we're all missing?
      </p>
        <p tabIndex="0">
          In this talk we'll dive into the structure of the feedback
          loop, some impressive examples of how powerful they can be and
          we'll explore how you can harness their power in your work and
          personal life.
      </p>
        <h3 tabIndex="0">Bio</h3>
        <div className="row">
          ...
          <div className="columnright">
            ...
            <p tabIndex="0">
              ...
              debt manage their money to providing early intervention
              for those displaying detrimental patterns of behaviour,
              Jess is using her academic background in psychology to
              create highly personalised, data led Money Coaching that
              drives long term, financial behavioural change for Tully
              customers.
          </p>
          </div>
        </div>
      ...
      <section name="anthony-dang">
        ...
        <p tabIndex="0">
          ...
          slowness, or both! It can even result in random stale (out of
          date) content which you can’t explain.
      </p>
        <p tabIndex="0">
          In this presentation we will demo and compare different
          caching methodologies, and their perceived real world uses. We
          will discuss Donut cache, Memory cache, Redis, Varnish, CDNs,
          and many more. We will dive into demos of real world
        ...
        <p tabIndex="0">
          ...
          different trade-offs with each caching methodology, and which
          might best for your situation.
      </p>
        <h3 tabIndex="0">Bio</h3>
        <div className="row">
          <div className="columnleft">
          ...
          <div className="columnright">
            ...
            <p tabIndex="0">
              ...
              presenter at conferences and meetups. He loves automation
              and development processes, experienced in scaling high
              performing teams across multiple countries, a Scrum
              certified Agile enthusiast, and a vocal proponent of
              Behaviour Driven Development. Originally from Sydney,
              Australia, he is now based in London.
          </p>
          </div>
        </div>
      </section>
      ...
      <section name="cara-holland">
        ...
        <h3 tabIndex="0">
          Talk:{' '}
          <i>Draw UX (or how to get your visual thinking groove on)</i>
        </h3>
        <p tabIndex="0">
          Working visually is a super power. It increases your ability
          to understand and share complex information, think creatively
          and collaborate effectively. But for lots of adults drawing at
          work is a huge step outside of their comfort zone.
      </p>
        <p tabIndex="0">
        ...
        <div className="row">
          ...
          <div className="columnright">
            ...
            <p tabIndex="0">
              ...
              last 13 years. She also co-runs the Graphic Change Academy
              which has trained people in over 69 countries how to start
              drawing at work.
          </p>
          </div>
        </div>
      ...
      <section name="mark-towndrow">
        ...
        <p tabIndex="0">
          It’s increasingly important to make time for self-improvement
          and career development, but it’s hard to know where to focus
          your efforts. As developers we’re often attracted to learning
          new technologies and languages, however I’d like to make the
          case for a number of non-technical areas of development that I
          believe can give you a huge advantage in your career.
      </p>
        <p tabIndex="0">
          ...
          requirements to identify opportunities for your business. I’ll
          also share some tips to help fast track your progress,
          exploring why it’s important to seek out and identify the gaps
          in your skill set, and how to seize opportunities to
        ...
        <p tabIndex="0">
          ...
          tools and motivation to broaden your expertise so that you can
      ...
      <section name="galiya-warrier">
        ...
        <p tabIndex="0">
          In this talk, we will discuss computer vision, one of the most
          common real-world applications of machine learning. We will
          deep dive into various state-of-the-art concepts around
          building custom image classifiers - application of deep neural
          networks, specifically convolutional neural networks and
          transfer learning. We will demonstrate how those approaches
          could be used to create your own image classifier to recognise
          the characters of "My Little Pony" TV Series [or Pokemon, or
          Superheroes, or your custom images].
      </p>
        <h3 tabIndex="0">Bio</h3>
        <div className="row">
          <div className="columnleft">
          ...
          <div className="columnright">
            ...
            <p tabIndex="0">
              I'm a Cloud Solution Architect at Microsoft, where I help
              enterprise customers adopt Advanced Analytics and
      ...
      <section name="robin-ninan">
        ...
        <h3>
          Talk: <i>Ditching the test pyramid in a microservices era</i>
        </h3>
        <p tabIndex="0">
          We have all heard tales of the infamous test pyramid. Some of
          us have scaled the pyramid, some camped halfway and some dare
          not even attempt. Time and time again, I've heard of the test
          pyramid in multiple talks, test articles and blog posts, but
          not many have dared stray away from it. Why do we often return
          to the same solution for every test problem?
      </p>
        <p tabIndex="0">
          What if we had another way forward; one that did not involve a
          pyramid. I once too advocated for the test pyramid in the good
          old times of monoliths. Times have changed.
      </p>
        <p tabIndex="0">
          We are now in the era of microservices and like many others, I
          found myself on shaky grounds with the test pyramid. It
          baffles me how little effort has been made to redefine or
          re-evaluate our quality assurance strategies. Whilst advances
          and breakthroughs are ripe in software development, our
          quality assurance processes and strategies often trail behind.
      </p>
        <p tabIndex="0">
          ...
          pyramid and we explore how we could succeed without having to
          scale the pyramid.
      </p>
        <p tabIndex="0">
          If you, like me started off with the search for a better test
          strategy that has been tried and tested in the microservices
          furnace and ended up unsatisfied with the answers; let me
      ...
      <section name="ian-johnson">
        ...
        <p tabIndex="0">
          ...
          system in my head. I should be able to reason where the change
          needs to be made and reason about the impact it will have.
      </p>
        <p tabIndex="0">
          I want to explore what reasonable means to me, from the
          processes of the team all the way down to an individual block
          of code. Along the way, we will encounter existing frameworks,
          tools, and patterns that our community has developed over the
          years to help us to reason about our code and processes; I
          feel that they have often been misused and end up creating the
          opposite effect, adding unnecessary complexity to how we work.
      </p>
        <h3 tabIndex="0">Bio</h3>
        <div className="row">
          <div className="columnleft">
          ...
          <div className="columnright">
            ...
            <p tabIndex="0">
              ...
              been known to make the occasional really bad pun, but all
              of his code is "no-pun sourced" (sorry, couldn't resist).
          </p>
            <ul>
              <li>
      ...
      <section name="samathy-barratt">
        ...
        <p tabIndex="0">
          ...
          represents the concept of nothing, zero or just 'not a thing'
          in a different way.
      </p>
        <p tabIndex="0">
          This talk looks at the various different representations of
          'nothing' in programming languages, exploring how the concept
          has developed over time, how representations differ and what
          each method has over another one.
      </p>
        <h3 tabIndex="0">Bio</h3>
        <div className="row">
          <div className="columnleft">
          ...
          <div className="columnright">
            ...
            <p tabIndex="0">
              A Python programmer by day, and a passionate D programmer
              by night, she likes good challenges, good code and good
              coffee.
          </p>
          </div>
        </div>
      ...
      <section name="ian-cooper">
        ...
        <p tabIndex="0">
          ...
          and dumb endpoints" and ask whatever happened to the vision of
          "smart endpoints and dumb pipes", and what you can do to
      ...
      <section name="helen-joy">
        ...
        <p tabIndex="0">
          ...
          really know who these people are? Do we really know what they
          need? Do we take the time to find out, or are we building
          products and services based on our own assumptions and biases?
      </p>
        <p tabIndex="0">
        ...
        <p tabIndex="0">
          ...
          adopting a practical user research-led attitude to design, we
          can create products that are not just appealing to us, but
          life-changing to those who use them.
      </p>
        <h3 tabIndex="0">Bio</h3>
        <div className="row">
          <div className="columnleft">
          ...
          <div className="columnright">
            ...
            <p tabIndex="0">
              ...
              She's an organiser of Women in Tech Nottingham, working to
              promote inclusivity within the tech industry and raise the
              profile of talented female and gender minority speakers.
              When not consulting or speaking at events, Helen is an
              avid coffee drinker and hot yoga fan.
          </p>
          </div>
        </div>
      </section>
        ...
        <div className="row">
          ...
          <div className="columnright">
            ...
            <p tabIndex="0">
              ...
              15 years and a passion for both technology and elegance in
              my solutions that make me an extremely capable software
              architect.
          </p>
            <p tabIndex="0">
              Personable and professional, I revel in complex
              challenges, but always make time to coach and mentor team
              members.
          </p>
          </div>
        </div>
      ...
      <section name="zac-braddy">
        ...
        <p tabIndex="0">
          We're now entering the next age of Microservices. For about a
          decade now we've been doing battle with the pointy haired
          bosses of the world to convince them of what seems so
          painfully obvious to us; that there are many varied virtues of
        ...
        <p tabIndex="0">
          Some people have been getting it right the first time they've
          tried which is great! Other people, like me, have got it right
          as well.....but....not before getting it wrong repeatedly for
          oh so many different reasons! So, I guess that makes me an
          expert, right?!
      </p>
        <p tabIndex="0">
          Come listen as I shamefully regale you with all ways in which
          I've ham-fisted the most elegant architecture currently known
          to humanity in hopes that I might save you from the same
          sleepless nights.
      </p>
        <h3 tabIndex="0">Bio</h3>
        <div className="row">
          ...
          <div className="columnright">
            ...
            <p tabIndex="0">
              ...
              think, I don't know who is counting? In that time has seen
              a very diverse set of tech and industries. Up until his
              current role he was working with the .NET stack so even
              languages are sacred to him. For Zac it's all about the
              next challenge and in the past that thirst for knowledge
              has seen him working with everything from hulking 20 year
              old Classic ASP monoliths to greenfield node microservices
              on bleed edge architecture and good amount of stuff in
              between.
          </p>
            <p tabIndex="0">
              On the side Zac is active in the developer community
              writing blog posts, doing talks and mentoring other
              developers through their journeys in meet ups and online.
              When he isn't in front of his computer at work he is out
      ...
      <section name="neil-oconnor">
        ...
        <p tabIndex="0">
          ...
          high performance development teams. I have hired hundreds of
          software professionals over the years, and I still insist on
          interviewing every candidate personally. I think I’ve got a
          pretty good hit rate: my teams have all had great reputations
          in their local tech community, and I would rehire - in a
          heartbeat - almost everyone I’ve hired in the past.
      </p>
        <p tabIndex="0">
          ...
          forward thinking companies. How do you set yourself apart from
          the crowd and get those companies falling over themselves to
          hire you?
      </p>
        <p tabIndex="0">
          ...
          that impresses me? How important is formal education? What do
          I look for in how the candidate spends their spare time?
      </p>
        <p tabIndex="0">
          ...
          capacity to learn. To continue the rockstar analogy, I’d much
          rather hire the reliable drummer or the skilful backing singer
          over the egotistical and unpredictable frontman!
      </p>
        <p tabIndex="0">
          This session will offer clear, practical advice on how you can
          maximise your personal value in the industry. Some of it will
          be quick and easy to achieve, while some of it will require
          you to make longer term changes to your mindset. But whether
          you are an old hand eyeing your next career move, or you are
          looking for your first job in the industry, there will be
          something in this talk for you.
      </p>
        <h3 tabIndex="0">Bio</h3>
        <div className="row">
          <div className="columnleft">
          ...
          <div className="columnright">
            ...
            <p tabIndex="0">
              ...
              something is worth doing, it's worth doing right, and aims
              to create environments where development teams can excel
      ...
      <section name="simon-painter">
        ...
        <p tabIndex="0">
          ...
          from it - I mean that I hate to write out a great deal of code
          to get the job done. I want to accomplish my goals with as
          little effort as possible.
      </p>
        <p tabIndex="0">
          One of my pet hates is writing enhancements that involve
          copying and pasting blocks of code, changing a variable name,
          then leaving everything else the same. I hate having to
          consider each and every possible null reference exception, and
          adding in a whole ton of boilerplate to handle it. I hate
          having to spent ages jumping back and forth in a legacy
        ...
        <div className="row">
          ...
          <div className="columnright">
            ...
            <p tabIndex="0">
              ...
              imagination could devise since I was old enough to read my
              Dad's copy of the ZX Spectrum BASIC coders manual.
          </p>
            <p tabIndex="0">
              I've been speaking about Functional C# at various user
              groups and conferences around the UK, USA, and India, and
              am particularly interested in seeing just how far we can
              push the capabilities of C#.
          </p>
            <p tabIndex="0">
              When I'm not coding, or running after my two small
              children, I have been known to enjoy the classic series of
              Doctor Who, Fighting Fantasy Gamebooks, Cryptic
