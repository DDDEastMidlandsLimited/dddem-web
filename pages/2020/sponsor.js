...
export default () => (
    <Layout>
        ...
        <h1 tabIndex="0">Indicating Interest to Sponsor</h1> 
            ...
            <p tabIndex="0">
              Please indicate your interest and we will get in touch. We will get in touch with companies in the 
              order that they have submitted their interest.
            </p>
            <a name="submitting-interest"/>
            <h2 tabIndex="0">We are changing the format for the better</h2>
            <p tabIndex="0">
              We are taking lessons from the first year and iterating. Part of this form is to help us do that.
              Let us know what benefits you are interested in, so that we can tailor our sponsorship pack to the majorities needs.
            </p>
            <br/>
            <SponsorButton/>
        </section> 
