  ...
  return (
    <Layout>
      ...
      <section>
        ...
        <p tabIndex="0">
          This lightning talk should serve as a quick intro to the API
          itself (including a quick demo) and an exploration of some
          of the creative applications people have managed to find for
          this powerful technology so far.
        </p>
      </section>
      <section>
