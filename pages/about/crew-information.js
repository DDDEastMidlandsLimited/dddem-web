...
export default () => (
    <Layout>
        ...
        <h1>Introduction</h1> 
            ...
            <h2>Thank you.</h2>
            <p>
                Without your support, there wouldn’t be a DDD East Midlands Conference. As members of the crew you play a key role in making the day a success. Thank you for being an involved. 
            </p>
            <p>
                This is going to be a great day full of amazing talks, exhibition stalls and more. Whilst you will be helping this happen half of the time you can also take full advantage of the conference for the other half. We hope you have a fantastic day when on and off shift.
            </p>
        </section>     
