  ...
  <Layout>
    ...
    <section id="introduction">
      ...
      <p>
        ...
        Conference. As members of the crew you play a key role in
        making the day a success. Thank you for being an involved.
      </p>
      <p>
        This is going to be a great day full of amazing talks,
        exhibition stalls and more. Whilst you will be helping this
        happen half of the time you can also take full advantage of
        the conference for the other half. We hope you have a
        fantastic day when on and off shift.
      </p>
    </section>
    ...
    <section id="where-and-when">
      ...
      <p>25th October 2019 6:00pm - 8:00pm.</p>
      <h2>Morning shift</h2>
      <p>26th October 2019 7:30am - 1:00pm.</p>
      <h2>Afternoon shift</h2>
      <p>26th October 2019 1:00pm - 7:00pm.</p>
      <h2>Where</h2>
      <p>
    ...
    <section id="duties">
      ...
      <p>
        More specifically this relates to occasions where attendees or
        others approach you to report code of conduct issues. In all
        circumstances:
        <ul>
          <li>
            Raise these as soon as possible in the crew slack
            (#code-of-conduct)
          </li>
          <li>Tag in the organisers</li>
          <li>Let them handle the issue</li>
        </ul>
        We take conduct issues seriously and will treat them as our
        top priority.
      </p>
      ...
      <p>
        ...
        <ul>
          <li>
            Run through of the duties on the day, what to expect and
            escalation points
          </li>
          <li>Walking tour of the venue and rooms</li>
          <li>
            Setup help with lanyards, banners, attendee bag etc.
          </li>
      ...
      <h2>Registration</h2>
      <p>
        If you are in the morning shift you will be helping people
        register. This involves:
        <ul>
          <li>Scanning people into eventbrite</li>
          <li>
            Ensuring they have a lanyard with the correct colour
          </li>
          <li>Ensuring they receive an attendee bag</li>
          <li>
            Ensuring they know that the lanyard slip contains
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            Help triage issues/escalations where appropriate and with
            support
          </li>
        </ul>
      </p>
      ...
      <p>
        ...
        <ul>
          <li>
            Administer communication via the crew slack, tagging in
            organisers as needed
          </li>
      ...
      <p>
        ...
        <ul>
          <li>
            Have some fun taking part and engaging with attendees,
            exhibitors, etc.
          </li>
          <li>
            Be visible as a potential escalation point for any
            questions/concerns in the space
          </li>
      ...
      <p>
        ...
        <ul>
          <li>
            Ensure the arrival of speakers, escalate if someone is not
            there 10 minutes before their talk so we have time to
            contact them
          </li>
          <li>
            Be visible as a potential escalation point for any
          ...
          <li>
            Ensure speakers are as comfortable as possible, have
            water, have what they need to set up. Be mindful that some
            people may want their own space, whilst others may welcome
            a chat
          </li>
          <li>
            Count votes and reset after a talk. Communicate results
            via slack (#evaluations). You may need to ask some people
            if they want to vote who are still in the room
          </li>
          <li>
            Ensure the next speaker has room/time to set up. You might
            need to gently herd people if there are a lot of questions
            or gently remind the current speaker about the time if
            things are running on
          </li>
        </ul>
        If you have any queries about the voting system or what the
        votes are used for, there is a section in the{' '}
        <a href="https://www.dddeastmidlands.com/about/attendee-information/#voting">
          attendee information
        </a>{' '}
        that goes over this in a bit more detail.
      </p>
      <a name="packing-up" />
      <h2>Packing up</h2>
      <p>
        If you are in the afternoon shift you will be helping us pack
        up. This involves:
        <ul>
          <li>
            Collecting banners, flags, posters, etc at the information
            desk
          </li>
    ...
    <section id="social-media">
      ...
      <p>You will be able to pick your lanyard on registration.</p>
      <a name="social-media" />
