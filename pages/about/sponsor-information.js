  ...
  <Layout>
    ...
    <section id="social-media">
      ...
      <p tabIndex="0">
        ...
        volunteers can come to your exhibition booth to record a short
      ...
      <p tabIndex="0">
        ...
        that doesn’t align with our code of conduct, or advertising
        job roles (unless allowed as part of your sponsorship
        agreement).
      </p>
    ...
    <section id="pubconf">
      ...
      <p tabIndex="0">
        Anyone can attend PubConf. They don't need to have gone to the
