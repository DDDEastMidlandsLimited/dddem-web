...
export default () => (
  <Layout>
    ...
    <section name="Contents">
      ...
      <p tabIndex="0">
        <strong>Frequently asked questions about submission.</strong>
      </p>
      <ul>
        <li>
    ...
    <section id="applicationhow">
      ...
      <p tabIndex="0">
        ...
        for all talk submission and organisation. We will write a blog
        again this year on how to fill in this form.
      </p>
      <p tabIndex="0">
        ...
        will vote on what they want to see and the most popular talks
        will be selected. We ask you do not include any identifiable
        information in your titles and talks descriptions, and that
        you don't share the titles of your submissions on social media
        to help keep this fair. More can be read about this process{' '}
        <a
    ...
    <section id="talklength">
      ...
      <p tabIndex="0">
        ...
        talks. We received feedback that this was intimidating to some
        people who otherwise would have submitted to the event.
      </p>
      <p tabIndex="0">
    ...
    <section id="multiple">
      ...
      <p tabIndex="0">
        ...
        talk gets into the top selected, only the most popular will be
        picked for presentation. We are limiting talks to one per
        speaker on the day.
      </p>
      <p tabIndex="0">
