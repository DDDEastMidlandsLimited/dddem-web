...
export default () => (
  <Layout>
    ...
    <section name="Contents">
      ...
      <ul>
        <li>
          <a href="#prayerroom">Will be a place to pray available?</a>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <a href="#genderbathrooms">Are bathrooms gender neutral?</a>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <a href="#wheelchairaccessoutside">
            What is wheelchair access like outside the venue? I.e. Are
            kerbs high?
          </a>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <a href="#alcohol">Are people going to be using alcohol?</a>
        </li>
      </ul>
    ...
    <section id="prayerroom">
      ...
      <p tabIndex="0">
        ...
        marked on the maps and all volunteers will know where it will
        be located.
      </p>
    </section>
    ...
    <section id="childcare">
      ...
      <p tabIndex="0">
        Unfortunately we will not be able to provide childcare at this
        first event. The overhead and cost were too high on this
        instance, but we would love to find a way in the future.
        Accessibility is important to us and we would love to make it
        easier for parents to attend the conference.
      </p>
    </section>
    ...
    <section id="wheelchairaccess">
      ...
      <p tabIndex="0">
        ...
        entrance are accessible and there are lifts to all levels. The
        wheelchair door on Burton Street is a push button entrance
        door.
      </p>
      ...
      <p tabIndex="0">
        Wheelchair access is good. There are no steps/lips on doors to
        watch out for.
      </p>
    ...
    <section id="audio-visual">
      ...
      <p tabIndex="0">
        ...
        is paid for, then we will be providing captioning, but this is
    ...
    <section id="dietary">
      ...
      <p tabIndex="0">
        ...
        Eventbrite registration, we will do our best to cater towards
        them.
      </p>
      ...
      <p tabIndex="0">
        ...
        reasons people may want to bring their own food and drink. We
        will be catering for vegetarian, vegan and ceoliac dietary
      ...
      <p tabIndex="0">We won't be providing alcohol at the event.</p>
    </section>
