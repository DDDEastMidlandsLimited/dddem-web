define('./workbox-c2b5e142.js', ['exports'], function (t) {
  ...
  let o;
  const h = () => (
    o || ((o = new c()), o.addFetchListener(), o.addCacheListener()),
    o
  );
  const u = {
  ...
  class y {
    constructor(
      t,
      e,
      { onupgradeneeded: s, onversionchange: n } = {},
    ) {
      (this.o = null),
        (this.h = t),
        (this.u = e),
          ...
          (this.o = await new Promise((t, e) => {
            ...
            (n.onerror = () => e(n.error)),
              ...
              (n.onsuccess = () => {
                ...
                s
                  ? e.close()
                  : ((e.onversionchange = this.p.bind(this)), t(e));
              });
          })),
          this
        );
  ...
  class v {
    ...
    async expireEntries() {
      ...
      (this.R = !1),
        this.U && ((this.U = !1), p(this.expireEntries()));
    }
    ...
    async isURLExpired(t) {
      if (this.N) {
        return (
          (await this._.getTimestamp(t)) < Date.now() - 1e3 * this.N
        );
      }
      return !1;
    }
  ...
  const R = (t, e) => t.filter((t) => e in t),
    ...
    x = async ({
      ...
      const h = await (async ({
        ...
        return (
          r || (i = i && 200 === i.status ? i : void 0), i || null
        );
    ...
    b = async ({
      ...
      try {
        let s;
        s =
          'navigate' === t.mode ? await fetch(t) : await fetch(t, e);
        for (const t of i)
    ...
    addToCacheList(t) {
      ...
      for (const n of t) {
        ...
        const { cacheKey: t, url: i } = M(n),
          r =
            'string' != typeof n && n.revision ? 'reload' : 'default';
